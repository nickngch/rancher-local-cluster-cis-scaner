...
check_1_2_11="1.2.11  - Ensure that the admission control plugin AlwaysAdmit is not set"
...
check_1_2_14="1.2.14  - Ensure that the admission control plugin ServiceAccount is set"
